          ...
          <div className="w-full lg:w-1/3">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <input
                ...
                className="flex-1 bg-white px-3 py-2.5 text-sm text-[#1e2d4f] placeholder:text-[#9ca3af] outline-none focus:ring-2 focus:ring-[#5a56e9]"
              />
              <button
                type="button"
                className="bg-[#4640DE] px-4 py-2.5 text-sm font-semibold text-white hover:bg-[#4844c7] transition-colors whitespace-nowrap max-w-[150px]"
              >
                Subscribe
              </button>
            </div>
